...
class SupportRequestsControllerTest < ActionController::TestCase
  ...
  test "should create support_request" do
    assert_difference('SupportRequest.count') do
      post :create, support_request: { category: @support_request.category, description: @support_request.description, percent_filled: @support_request.percent_filled }
    end
  ...
  test "should update support_request" do
    patch :update, id: @support_request, support_request: { category: @support_request.category, description: @support_request.description, percent_filled: @support_request.percent_filled }
    assert_redirected_to support_request_path(assigns(:support_request))
  end
